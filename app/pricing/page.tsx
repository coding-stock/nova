...
function Pricing() {
  return (
    ...
    <div className={clsx(styles.container ,   'text-white , font-bold')}>
        ...
        <div className={clsx( styles.card , styles.nova ,"flex flex-col gap-3 p-2  bg-black/30 backdrop-blur-md border border-white/25")}>
          ...
          <div className="w-full h-0.5 bg-white/35"></div>
          <article className="flex items-center"><h1 className="text-2xl">750,000 RWF</h1><p>/starting price</p></article>
          <article className="flex flex-col gap-1">
